...
% This function takes as input the vector generated by MarkovSorce. It
...
for i = 1 : length(input)
    if (i ~= length(input) && (input(i) ~= currentSource && input(i + 1) ~= currentSource))
        ...
        if (currentSource == input(1))
            bitEncoding = [bitEncoding, Run_Length_Encoder_Markov(currentSourceRun, max_run_length, currentSource, oppSource)];
